...
const emotionConfig = {
  anxiety: { icon: AlertTriangle, color: "bg-yellow-500/10 text-yellow-600 border-yellow-500/20", label: "Anxiety" },
  depression: { icon: Frown, color: "bg-blue-500/10 text-blue-600 border-blue-500/20", label: "Depression" },
  anger: { icon: Zap, color: "bg-red-500/10 text-red-600 border-red-500/20", label: "Anger" },
  joy: { icon: Smile, color: "bg-green-500/10 text-green-600 border-green-500/20", label: "Joy" },
