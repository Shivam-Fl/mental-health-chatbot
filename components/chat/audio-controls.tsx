...
export function AudioControls({ onTranscriptReceived, conversationId }: AudioControlsProps) {
  ...
  const getStatusInfo = () => {
    switch (status) {
      case "listening":
        return { text: "Listening...", color: "bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/20" }
      case "processing":
        return { text: "Processing...", color: "bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/20" }
      case "speaking":
        return { text: "Speaking...", color: "bg-purple-500/10 text-purple-600 dark:text-purple-400 border-purple-500/20" }
      default:
        return { text: "Ready", color: "bg-muted text-muted-foreground border-border" }
    }
  }
